...
def distanceK( root, target, k):
    ...
    # parent = { }
    markParents(root) # error de ga reson return ing parent but wher it is storing bhai ?therfore error
...
# op error   NameError: name 'parent' is not defined. Did you mean: 'print'?